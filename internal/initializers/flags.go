...
func ParseFlags() (port string, threads int, jcAPI string, jc bool, scope string, proxy string, config string, output string, updatePlugins bool, exportCA bool, debug bool) {
...
func PrintFlagsByTopic() {
    ...
    topics := map[string][]string{
        ...
        "Misc": []string{"update-plugins", "export-ca", "debug"},
    }
