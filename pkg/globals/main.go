...
var RequestsMade int64          // Number of requests sent by the scanner
...
func init() {
	Port, Threads, Delay, Proxy, PluginsConfig, Output, ExportCA, Debug, Version, Stats, ListPlugins, Headers, CustomParams = ParseFlags()
}
